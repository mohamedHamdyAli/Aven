<x-admin::layouts>
    <x-slot:title>
        @lang('social-commerce::app.admin.social-channels.edit.title')
    </x-slot>

    <x-admin::form
        :action="route('admin.social-commerce.channels.update', $platform->id)"
        method="PUT"
    >
        <div class="flex items-center justify-between gap-4 max-sm:flex-wrap">
            ...
            <div class="flex items-center gap-x-2.5">
                ...
                <button type="submit" class="primary-button">
                    @lang('social-commerce::app.admin.social-channels.edit.save-btn')
                </button>
            </div>
        </div>
                    ...
                    <x-slot:content>
                        <x-admin::form.control-group class="mb-2.5">
                            ...
                            <x-admin::form.control-group.control
                                type="select"
                                name="channel_id"
                                :value="old('channel_id', $platform->channel_id)"
                            >
                                @foreach ($channels as $channel)
                                    <option
                                        value="{{ $channel->id }}"
                                        @selected(old('channel_id', $platform->channel_id) == $channel->id)
                                    >
                                        {{ $channel->name }}
                                    </option>
                                @endforeach
                        ...
                        <x-admin::form.control-group class="mb-2.5">
                            ...
                            >
                                <option value="facebook"  @selected(old('platform', $platform->platform) === 'facebook')>Facebook</option>
                                <option value="instagram" @selected(old('platform', $platform->platform) === 'instagram')>Instagram</option>
                                <option value="tiktok"    @selected(old('platform', $platform->platform) === 'tiktok')>TikTok</option>
                                <option value="youtube"   @selected(old('platform', $platform->platform) === 'youtube')>YouTube</option>
                                <option value="whatsapp"  @selected(old('platform', $platform->platform) === 'whatsapp')>WhatsApp</option>
                            </x-admin::form.control-group.control>
                        ...
                        <x-admin::form.control-group class="mb-2.5">
                            ...
                            <x-admin::form.control-group.control
                                type="text"
                                name="page_url"
                                :value="old('page_url', $platform->page_url)"
                            />
                        ...
                        <x-admin::form.control-group class="mb-2.5">
                            ...
                            <x-admin::form.control-group.control
                                type="text"
                                name="page_id"
                                :value="old('page_id', $platform->page_id)"
                            />
                        </x-admin::form.control-group>
                    ...
                    <x-slot:content>
                        <x-admin::form.control-group class="mb-2.5">
                            ...
                            <x-admin::form.control-group.control
                                type="text"
                                name="pixel_id"
                                :value="old('pixel_id', $platform->pixel_id)"
                            />
                        </x-admin::form.control-group>
                    </x-slot>
                </x-admin::accordion>
                    ...
                    <x-slot:content>
                        <x-admin::form.control-group class="mb-2.5">
                            ...
                            <x-admin::form.control-group.control
                                type="text"
                                name="app_id"
                                :value="old('app_id', $platform->app_id)"
                            />
                        </x-admin::form.control-group>
                        ...
                        <x-admin::form.control-group class="mb-2.5">
                            ...
                            <x-admin::form.control-group.control
                                type="password"
                                name="app_secret"
                                placeholder="@lang('social-commerce::app.admin.social-channels.edit.leave-blank')"
                            />
                        </x-admin::form.control-group>
                        ...
                        <x-admin::form.control-group class="mb-2.5">
                            ...
                            <x-admin::form.control-group.control
                                type="text"
                                name="catalog_id"
                                :value="old('catalog_id', $platform->catalog_id)"
                            />
                        </x-admin::form.control-group>
                        ...
                        <x-admin::form.control-group class="mb-2.5">
                            ...
                            <x-admin::form.control-group.control
                                ...
                                :value="old('phone_number_id', $platform->phone_number_id)"
