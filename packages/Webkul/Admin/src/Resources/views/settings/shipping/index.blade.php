<x-admin::layouts>
    ...
    <div class="flex flex-col gap-6">
        ...
        <div class="flex items-center justify-between">
            ...
            <a
                href="{{ route('admin.configuration.index', ['slug' => 'sales', 'slug2' => 'carriers']) }}"
                ...
                <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
                    @foreach ($group['items'] as $item)
                        <div class="flex flex-col gap-3 rounded-lg border border-gray-200 bg-white p-5 shadow-sm dark:border-gray-700 dark:bg-gray-900">
                            ...
                            <div class="flex items-center justify-between">
                                <div
                                    class="flex h-10 w-10 items-center justify-center rounded-lg text-white text-xl"
