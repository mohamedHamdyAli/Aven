...
<x-admin::layouts>
    <x-slot:title>
        @lang('admin::app.store-locator.create.title')
    </x-slot>

    <x-admin::form
        :action="route('admin.store-locator.store')"
    ...
    >
        <div class="flex items-center justify-between gap-4 max-sm:flex-wrap">
            ...
            <div class="flex items-center gap-x-2.5">
                ...
                >
                    @lang('admin::app.store-locator.create.back-btn')
                </a>

                <button type="submit" class="primary-button">
                    @lang('admin::app.store-locator.create.save-btn')
                </button>
            </div>
        </div>
        ...
        <div class="mt-3.5 flex gap-2.5 max-xl:flex-wrap">
            ...
            <div class="flex flex-1 flex-col gap-2 max-xl:flex-auto">
                ...
                <div class="box-shadow rounded bg-white p-4 dark:bg-gray-900">
                    <p class="mb-4 text-base font-semibold text-gray-800 dark:text-white">
                        @lang('admin::app.store-locator.create.basic-info')
                    </p>

                    <!-- Name -->
                    <x-admin::form.control-group>
                        <x-admin::form.control-group.label class="required">
                            @lang('admin::app.store-locator.create.name')
                        ...
                        <x-admin::form.control-group.control
                            ...
                            rules="required"
                            :value="old('name')"
                            :label="trans('admin::app.store-locator.create.name')"
                            :placeholder="trans('admin::app.store-locator.create.name')"
                        />
                    ...
                    <x-admin::form.control-group>
                        <x-admin::form.control-group.label>
                            @lang('admin::app.store-locator.create.phone')
                        </x-admin::form.control-group.label>
                        ...
                        <x-admin::form.control-group.control
                            ...
                            name="phone"
                            :value="old('phone')"
                            :label="trans('admin::app.store-locator.create.phone')"
                            :placeholder="trans('admin::app.store-locator.create.phone')"
                        />
                    ...
                    <x-admin::form.control-group class="!mb-0">
                        <x-admin::form.control-group.label class="required">
                            @lang('admin::app.store-locator.create.address')
                        </x-admin::form.control-group.label>
                        ...
                        <x-admin::form.control-group.control
                            ...
                            rules="required"
                            :value="old('address')"
                            :label="trans('admin::app.store-locator.create.address')"
                            :placeholder="trans('admin::app.store-locator.create.address-placeholder')"
                        />
                ...
                <div class="box-shadow rounded bg-white p-4 dark:bg-gray-900">
                    <p class="mb-3 text-base font-semibold text-gray-800 dark:text-white">
                        @lang('admin::app.store-locator.create.map-title')
                    </p>

                    <p class="mb-3 text-sm text-gray-500 dark:text-gray-400">
                        @lang('admin::app.store-locator.create.map-hint')
                    </p>
                    ...
                    @else
                        <div class="rounded-lg border border-amber-300 bg-amber-50 p-4 text-amber-800 dark:bg-amber-900/20 dark:text-amber-300">
                            @lang('admin::app.store-locator.create.no-api-key')
                            <a href="{{ route('admin.configuration.index', 'store_locator/settings') }}" class="underline">
                                @lang('admin::app.store-locator.create.configure-api-key')
                            </a>
                        </div>

                        <!-- Manual lat/lng when no API key -->
                        <div class="mt-3 grid grid-cols-2 gap-4">
                            <x-admin::form.control-group class="!mb-0">
                                <x-admin::form.control-group.label class="required">
                                    @lang('admin::app.store-locator.create.latitude')
                                </x-admin::form.control-group.label>
                                <input
                                    type="number"
                                    step="any"
                            ...
                            <x-admin::form.control-group class="!mb-0">
                                <x-admin::form.control-group.label class="required">
                                    @lang('admin::app.store-locator.create.longitude')
                                </x-admin::form.control-group.label>
                                <input
                                    type="number"
                                    step="any"
                ...
                <div class="box-shadow rounded bg-white p-4 dark:bg-gray-900">
                    <p class="mb-4 text-base font-semibold text-gray-800 dark:text-white">
                        @lang('admin::app.store-locator.create.working-hours')
                    </p>
                                    ...
                                    <tr class="border-b dark:border-gray-700">
                                        ...
                                        <td class="py-2 pr-4">
                                            <input
                                                ...
                                                value="{{ old('working_hours.'.$day.'.from', '09:00') }}"
                                        ...
                                        <td class="py-2">
                                            <input
                                                ...
                                                value="{{ old('working_hours.'.$day.'.to', '22:00') }}"
                                                class="hours-field-{{ $day }} rounded border px-2 py-1 text-sm dark:border-gray-600 dark:bg-gray-800 dark:text-white"
                                                {{ ! $isOpen ? 'disabled' : '' }}
                                            />
                                        </td>
            ...
            <div class="flex w-[360px] max-w-full flex-col gap-2 max-sm:w-full">
                ...
                <x-admin::accordion>
                    <x-slot:header>
                        <p class="p-2.5 text-base font-semibold text-gray-800 dark:text-white">
                            @lang('admin::app.store-locator.create.status')
                        </p>
                    </x-slot>
                    ...
                    <x-slot:content>
                        <x-admin::form.control-group class="!mb-0 flex items-center gap-4">
                            <x-admin::form.control-group.control
                                ...
                                name="status"
                                value="1"
                                :label="trans('admin::app.store-locator.create.status')"
                                :checked="old('status', true)"
                            />
                            <x-admin::form.control-group.label class="!mb-0">
                                @lang('admin::app.store-locator.create.active')
                            </x-admin::form.control-group.label>
                        </x-admin::form.control-group>
                    </x-slot>
                </x-admin::accordion>
                ...
                <x-admin::accordion>
                    <x-slot:header>
                        <p class="p-2.5 text-base font-semibold text-gray-800 dark:text-white">
                            @lang('admin::app.store-locator.create.image')
                        </p>
                    </x-slot>
                    ...
                    <x-slot:content>
                        <x-admin::form.control-group class="!mb-0">
                            <x-admin::form.control-group.control
                                type="image"
                                name="image"
                                :label="trans('admin::app.store-locator.create.image')"
                            />
