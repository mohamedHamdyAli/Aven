...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('title', null, []); ?> 
        <?php echo app('translator')->get('egypt-shipping::app.admin.egypt-shipping.title'); ?>
     <?php $__env->endSlot(); ?>
    ...
    <div class="grid grid-cols-3 gap-4 mb-6">
        <div class="rounded-lg border border-gray-200 bg-white p-4 dark:border-gray-800 dark:bg-gray-900">
            <p class="text-sm text-gray-500 dark:text-gray-400"><?php echo app('translator')->get('egypt-shipping::app.admin.egypt-shipping.stats.total'); ?></p>
            <p class="text-3xl font-bold text-gray-800 dark:text-white"><?php echo e($stats['total']); ?></p>
        </div>
        <div class="rounded-lg border border-gray-200 bg-white p-4 dark:border-gray-800 dark:bg-gray-900">
            <p class="text-sm text-gray-500 dark:text-gray-400"><?php echo app('translator')->get('egypt-shipping::app.admin.egypt-shipping.stats.active'); ?></p>
            <p class="text-3xl font-bold text-green-600"><?php echo e($stats['active']); ?></p>
        </div>
        <div class="rounded-lg border border-gray-200 bg-white p-4 dark:border-gray-800 dark:bg-gray-900">
            <p class="text-sm text-gray-500 dark:text-gray-400"><?php echo app('translator')->get('egypt-shipping::app.admin.egypt-shipping.stats.priced'); ?></p>
            <p class="text-3xl font-bold text-blue-600"><?php echo e($stats['priced']); ?></p>
        </div>
    </div>
    ...
    >
        ...
        <label class="flex cursor-pointer items-center gap-2 text-sm font-medium text-gray-700 dark:text-gray-300">
            ...
            >
            <?php echo app('translator')->get('egypt-shipping::app.admin.egypt-shipping.select-all'); ?>
        </label>

        <span class="text-gray-300 dark:text-gray-600">|</span>

        <span id="selected-count" class="text-sm text-blue-700 dark:text-blue-400 font-medium min-w-[80px]">
            <?php echo app('translator')->get('egypt-shipping::app.admin.egypt-shipping.none-selected'); ?>
        </span>
        ...
        <div class="flex items-center gap-2 ltr:ml-auto rtl:mr-auto">
            <input
                ...
                min="0"
                step="0.01"
                placeholder="<?php echo app('translator')->get('egypt-shipping::app.admin.egypt-shipping.bulk-rate-placeholder'); ?>"
            ...
            <button
                ...
                disabled
            >
                <?php echo app('translator')->get('egypt-shipping::app.admin.egypt-shipping.bulk-apply'); ?>
            </button>
        </div>
    ...
    <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3" id="governorates-grid">
        <?php $__currentLoopData = $governorates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $gov): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div
                ...
                id="gov-card-<?php echo e($gov->id); ?>"
                data-id="<?php echo e($gov->id); ?>"
            >
                <div class="flex items-start justify-between mb-3">
                    ...
                    <div class="flex-1 mx-2">
                        <p class="font-semibold text-gray-800 dark:text-white"><?php echo e($gov->name_ar); ?></p>
                        <p class="text-sm text-gray-500 dark:text-gray-400"><?php echo e($gov->name_en); ?></p>
                    </div>
                    ...
                    <label class="relative inline-flex cursor-pointer items-center">
                        <input
                            ...
                            data-id="<?php echo e($gov->id); ?>"
                            <?php echo e($gov->is_active ? 'checked' : ''); ?>
                ...
                <div class="flex items-center gap-2">
                    <input
                        ...
                        data-id="<?php echo e($gov->id); ?>"
                        value="<?php echo e($gov->rate ?? ''); ?>"
                        placeholder="<?php echo app('translator')->get('egypt-shipping::app.admin.egypt-shipping.rate-placeholder'); ?>"
                    >
                    <button
                        class="gov-save-btn rounded-md bg-blue-600 px-3 py-1.5 text-sm font-medium text-white hover:bg-blue-700 transition"
                        data-id="<?php echo e($gov->id); ?>"
                    >
                        <?php echo app('translator')->get('egypt-shipping::app.admin.egypt-shipping.save'); ?>
                    </button>
                </div>

                <p class="gov-feedback-<?php echo e($gov->id); ?> mt-1 hidden text-xs text-green-600"></p>
            </div>
    ...
    <?php $__env->startPush('scripts'); ?>
        <script>
        (function () {
            var adminUrl = <?php echo json_encode(url(config('app.admin_url', 'admin').'/egypt-shipping'), 512) ?>;
            var bulkUrl  = <?php echo json_encode(route('admin.egypt-shipping.bulk-update'), 15, 512) ?>;
...
<?php endif; ?>
<?php /**PATH D:\aven\packages\Webkul\EgyptShipping\src\Resources\views\admin\egypt-shipping\index.blade.php ENDPATH**/ ?>