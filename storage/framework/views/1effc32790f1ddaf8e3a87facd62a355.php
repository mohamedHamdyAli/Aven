...
<?php if (! $__env->hasRenderedOnce('59e7d900-bcf3-42de-8342-3e093cf5734c')): $__env->markAsRenderedOnce('59e7d900-bcf3-42de-8342-3e093cf5734c');
                        ...
                        <template v-else>
                            <div class="row grid min-h-[260px] place-content-center justify-items-center gap-3 border-b px-4 py-8 text-center text-gray-600 dark:border-gray-800 dark:text-gray-300">
                                ...
                                <p class="max-w-sm text-sm text-gray-400 dark:text-gray-400">
                                    <?php echo app('translator')->get('admin::app.components.datagrid.table.no-records-hint'); ?>
                                </p>
                            </div>
                        </template>
                    </template>
...
<?php /**PATH D:\aven\packages\Webkul\Admin\src/resources/views/components/datagrid/table.blade.php ENDPATH**/ ?>