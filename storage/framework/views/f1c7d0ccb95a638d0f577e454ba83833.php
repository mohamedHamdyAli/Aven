    ...
    <div class="flex items-center gap-1 sm:gap-1.5">
        ...
        <a href="<?php echo e(route('admin.dashboard.index')); ?>" class="flex-shrink-0">
            <?php if($logo = core()->getConfigData('general.design.admin_logo.logo_image')): ?>
                ...
                />
            <?php elseif($channelLogo = core()->getCurrentChannel()->logo_url): ?>
                <img
                    class="h-8 w-auto sm:h-10"
                    src="<?php echo e($channelLogo); ?>"
                    alt="<?php echo e(config('app.name')); ?>"
                />
            <?php else: ?>
                <img
...
<?php if (! $__env->hasRenderedOnce('87882af1-86b8-4e02-9cab-8267666cdea2')): $__env->markAsRenderedOnce('87882af1-86b8-4e02-9cab-8267666cdea2');
...
<?php $__env->stopPush(); endif; ?><?php /**PATH D:\aven\packages\Webkul\Admin\src/resources/views/components/layouts/header/index.blade.php ENDPATH**/ ?>