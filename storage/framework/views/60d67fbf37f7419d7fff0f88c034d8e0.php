...
<?php if (! $__env->hasRenderedOnce('42a8d58b-df48-4b9f-ada1-32c19eb926e3')): $__env->markAsRenderedOnce('42a8d58b-df48-4b9f-ada1-32c19eb926e3');
...
<?php endif; ?>
                ...
                <div class="action-items bg-black">
                    ...
                    <div class="absolute top-1.5 flex flex-col gap-1 ltr:left-1.5 rtl:right-1.5">
                        ...
                        >
                            <?php echo app('translator')->get('shop::app.components.products.card.low-stock'); ?>
                        </p>
                        ...
                        >
                            <?php echo app('translator')->get('shop::app.components.products.card.popular'); ?>
                        </p>
                    ...
                    >
                        <?php echo app('translator')->get('shop::app.components.products.card.quick-view'); ?>
                    </button>
                </div>
                    ...
                    <template v-else>
                        <div style="padding:0 12px 8px">
                            ...
                            >
                                ...
                                <span v-else><?php echo app('translator')->get('shop::app.components.products.card.add-to-cart'); ?></span>
                            </button>
                        </div>
                    </template>
                </div>
                    ...
                    <div class="flex flex-col sm:flex-row">
                        ...
                        <div class="flex flex-col justify-center gap-4 p-6 sm:w-1/2">
                            ...
                            <div class="flex flex-wrap gap-3">
                                ...
                                >
                                    <?php echo app('translator')->get('shop::app.components.products.card.view-full-details'); ?>
                                </a>
                            </div>
                        </div>
                    </div>
            ...
            methods: {
                ...
                addToCart() {
                    ...
                    if (! this.product.type || this.product.type !== 'simple') {
                        window.location.href = '<?php echo e(route('shop.product_or_category.index', ':slug')); ?>'.replace(':slug', this.product.url_key);
                ...
                openQuickAdd() {
                    ...
                    this.$axios.get(`<?php echo e(route('shop.api.products.configurable.options', ':id')); ?>`.replace(':id', this.product.id))
                        .then(response => {
                ...
                addToCartWithVariant() {
                    ...
                    this.$axios.post('<?php echo e(route("shop.api.checkout.cart.store")); ?>', {
                        ...
                        .catch(error => {
                            ...
                            this.$emitter.emit('add-flash', { type: 'error', message: error.response?.data?.message || "<?php echo app('translator')->get('shop::app.components.products.card.error-adding-to-cart'); ?>" });
                        });
                },
            },
        });
...
<?php /**PATH D:\aven\packages\Webkul\Shop\src/resources/views/components/products/card.blade.php ENDPATH**/ ?>