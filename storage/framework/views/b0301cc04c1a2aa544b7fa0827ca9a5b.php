...
<body class="min-h-screen bg-gradient-to-br from-blue-50 via-white to-indigo-50 flex items-center justify-center p-4">
    ...
    <div class="w-full max-w-md">
        ...
        <div class="bg-white rounded-2xl shadow-xl border border-gray-100 p-8">
            ...
            <form method="POST" action="<?php echo e(route('shareholder.portal.do_login')); ?>" class="flex flex-col gap-5">
                <?php echo csrf_field(); ?>
...
<?php /**PATH D:\aven\packages\Webkul\CostManagement\src\Resources\views\shareholder-portal\login.blade.php ENDPATH**/ ?>