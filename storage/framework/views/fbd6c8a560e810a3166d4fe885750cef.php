    ...
    <div class="container">
        ...
        <?php if($fawryRef): ?>
            ...
            <div class="ref-box">
                ...
                <div class="ref-number"><?php echo e($fawryRef); ?></div>
            </div>
            <p class="instructions">
                ...
                <br><br>
                <strong>Order #<?php echo e($order->increment_id); ?></strong><br>
                Amount: <?php echo e(number_format($order->grand_total, 2)); ?> <?php echo e($order->order_currency_code); ?>

            </p>
            <a href="<?php echo e(route('shop.checkout.onepage.success')); ?>" class="btn">Done</a>
        <?php else: ?>
...
<?php /**PATH D:\aven\packages\Webkul\Fawry\src\Resources\views\redirect.blade.php ENDPATH**/ ?>