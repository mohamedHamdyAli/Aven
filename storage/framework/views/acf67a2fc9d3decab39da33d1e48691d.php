<?php $__env->startSection('page_title', 'Affiliate Dashboard'); ?>
...
<div class="container mx-auto max-w-4xl px-4 py-10">
    ...
    <?php if(session('success')): ?>
        <div class="mb-4 rounded-lg border border-green-200 bg-green-50 px-4 py-3 text-sm text-green-700"><?php echo e(session('success')); ?></div>
    <?php endif; ?>
    ...
    <div class="mb-8 grid grid-cols-2 gap-4 sm:grid-cols-4">
        <div class="rounded-2xl border border-gray-100 bg-white p-4 shadow-sm">
            ...
            <p class="mt-1 text-2xl font-bold text-indigo-600"><?php echo e($affiliate->commission_rate); ?>%</p>
        </div>
        <div class="rounded-2xl border border-gray-100 bg-white p-4 shadow-sm">
            <p class="text-xs text-gray-500">Total Earned</p>
            <p class="mt-1 text-2xl font-bold text-green-600"><?php echo e(core()->formatPrice($affiliate->total_earned)); ?></p>
        </div>
        <div class="rounded-2xl border border-gray-100 bg-white p-4 shadow-sm">
            <p class="text-xs text-gray-500">Total Paid</p>
            <p class="mt-1 text-2xl font-bold text-gray-600"><?php echo e(core()->formatPrice($affiliate->total_paid)); ?></p>
        </div>
        <div class="rounded-2xl border border-gray-100 bg-white p-4 shadow-sm">
            <p class="text-xs text-gray-500">Pending</p>
            <p class="mt-1 text-2xl font-bold text-orange-500"><?php echo e(core()->formatPrice($affiliate->pendingBalance())); ?></p>
        </div>
    </div>
    ...
    <?php if($affiliate->status === 'approved'): ?>
        ...
        <div class="mb-8 rounded-xl border border-indigo-100 bg-indigo-50 p-5">
            ...
            <div class="flex items-center gap-2">
                <input type="text" value="<?php echo e(url('/ref/' . $affiliate->code)); ?>" readonly
                ...
                <tbody>
                    <?php $__currentLoopData = $commissions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr class="border-b border-gray-50 hover:bg-gray-50">
                            ...
                            <td class="px-4 py-3 text-right font-semibold text-green-700"><?php echo e(core()->formatPrice($c->commission)); ?></td>
...
<?php echo $__env->make('shop::layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\aven\packages\Webkul\Affiliate\src\Resources\views\shop\dashboard.blade.php ENDPATH**/ ?>