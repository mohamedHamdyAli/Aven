...
<?php if (! $__env->hasRenderedOnce('d9a387d7-68f1-4ce4-9bb8-ad1923d6a2eb')): $__env->markAsRenderedOnce('d9a387d7-68f1-4ce4-9bb8-ad1923d6a2eb');
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'shop::components.quantity-changer.index','data' => ['vIf' => 'item.can_change_qty',':key' => '\'qty-\' + item.id + \'-\' + refreshKey','class' => 'max-h-9 max-w-[150px] gap-x-2.5 rounded-[54px] px-3.5 py-1.5 max-md:gap-x-2 max-md:px-1 max-md:py-0.5','name' => 'quantity',':value' => 'item?.quantity','@change' => 'updateItem($event, item)']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['v-if' => 'item.can_change_qty',':key' => '\'qty-\' + item.id + \'-\' + refreshKey','class' => 'max-h-9 max-w-[150px] gap-x-2.5 rounded-[54px] px-3.5 py-1.5 max-md:gap-x-2 max-md:px-1 max-md:py-0.5','name' => 'quantity',':value' => 'item?.quantity','@change' => 'updateItem($event, item)']); ?>
...
<?php /**PATH D:\aven\packages\Webkul\Shop\src/resources/views/checkout/cart/mini-cart.blade.php ENDPATH**/ ?>